...
import com.fetnet.portal.aem.ebu.context.TestContext;
...
public class PageImplTest {
    ...
    protected com.day.cq.wcm.api.Page testPage;
    ...
    public void beforeTest() {
        ...
        testPage = CONTEXT.pageManager().getPage(PAGE);
        ...
        slingBindings.put(WCMBindings.CURRENT_PAGE, testPage);
        slingBindings.put(WCMBindings.PAGE_MANAGER, CONTEXT.pageManager());
        slingBindings.put(SlingBindings.RESOURCE, resourceSpy);
        slingBindings.put(WCMBindings.PAGE_PROPERTIES, testPage.getProperties());
